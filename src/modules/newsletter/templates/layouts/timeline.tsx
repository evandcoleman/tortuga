...
// The rail carries a date-like label. EnrichedItem.addedAt is the chronological
// anchor for a "what's new" digest; when it is absent or unparseable we fall
// back to the item kicker so the spine never renders a blank marker.
function railLabels(item: EnrichedItem): { primary: string; secondary: string | null } {
...
export function TimelineItems({ items, theme, itemDisplay }: LayoutItemsProps) {
...
function TimelineEntry({
  ...
  const { primary, secondary } = railLabels(item);
